...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        // it has to be done before creation a class object
        // in another case data will be reloaded
        let tasks = TaskStorage().loadTasks()
        
        // loading of the scene with the task list
        ...
        // transition the task list to the controller
        taskListController.setTasks(tasks)
        
        // creation of the navigation controller
